...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--input_dir", type=str, required=True, help="Input images directory"
    )
    parser.add_argument(
        "--output_dir", type=str, required=True, help="Output directory"
    )
    parser.add_argument(
        "--mask_dir", type=str, required=True, help="Input masks directory"
    )
    parser.add_argument(
        "--mask_inv_dir", type=str, required=True, help="Input inverted masks directory"
    )

    args = parser.parse_args()

    prepare_repaint_data(
        args.input_dir, args.output_dir, args.mask_dir, args.mask_inv_dir
    )
