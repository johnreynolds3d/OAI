...
# weights=ResNet50_Weights.DEFAULT means we load the most up-to-date weights trained on the ImageNet dataset
...
predictions = [float(p.item()) for p in predictions]
actuals = [float(a.item()) for a in actuals]
